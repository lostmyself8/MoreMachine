...
import com.jerry.mekmm.common.recipe.lookup.monitor.MMRecipeCacheLookupMonitor;
...
public abstract class MMTileEntityRecipeMachine<RECIPE extends MekanismRecipe<?>> extends TileEntityConfigurableMachine implements IMMRecipeLookupHandler<RECIPE> {
    ...
    protected MMTileEntityRecipeMachine(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes) {
