...
public abstract class MMDoubleInputRecipeCache<INPUT_A, INGREDIENT_A extends InputIngredient<INPUT_A>, INPUT_B, INGREDIENT_B extends InputIngredient<INPUT_B>,
    ...
    /**
     * Helper expansion class for {@link MMDoubleInputRecipeCache} to simplify the generics when both inputs are of the same type.
     */
    public abstract static class MMDoubleSameInputRecipeCache<INPUT, INGREDIENT extends InputIngredient<INPUT>, RECIPE extends MekanismRecipe<?> & BiPredicate<INPUT, INPUT>,
        ...
        protected MMDoubleSameInputRecipeCache(MMRecipeType<?, RECIPE, ?> recipeType, Function<RECIPE, INGREDIENT> inputAExtractor,
