...
public abstract class MMGuiTankGauge<T, TANK> extends MMGuiGauge<T> implements IRecipeViewerIngredientHelper {

    private final ITankInfoHandler<TANK> infoHandler;
    private final TankType tankType;

    public MMGuiTankGauge(MMGaugeType type, IGuiWrapper gui, int x, int y, int sizeX, int sizeY, ITankInfoHandler<TANK> infoHandler, TankType tankType) {
