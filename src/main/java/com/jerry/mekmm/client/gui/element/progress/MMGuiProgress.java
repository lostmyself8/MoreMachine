package com.jerry.mekmm.client.gui.element.progress;
...
public class MMGuiProgress extends GuiTexturedElement implements IMMRecipeViewerRecipeArea<MMGuiProgress>, ISupportsWarning<MMGuiProgress> {
    ...
    public MMGuiProgress(IBooleanProgressInfoHandler handler, ProgressType type, IGuiWrapper gui, int x, int y) {
        this((IProgressInfoHandler) handler, type, gui, x, y);
    }

    public MMGuiProgress(IProgressInfoHandler handler, ProgressType type, IGuiWrapper gui, int x, int y) {
        super(type.getTexture(), gui, x, y, type.getWidth(), type.getHeight());
        this.type = type;
        this.handler = handler;
    }

    public MMGuiProgress colored(ColorDetails colorDetails) {
        this.colorDetails = colorDetails;
        return this;
    }

    @Override
    public MMGuiProgress warning(@NotNull WarningType type, @NotNull BooleanSupplier warningSupplier) {
    ...
    @NotNull
    @Override
    public MMGuiProgress recipeViewerCategories(@NotNull IMMRecipeViewerRecipeType<?>... recipeCategories) {
