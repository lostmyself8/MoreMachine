...
public class MMItemStackToItemStackRecipeCategory extends MMHolderRecipeCategory<ItemStackToItemStackRecipe> {

    private final GuiSlot input;
    private final GuiSlot output;

    public MMItemStackToItemStackRecipeCategory(IGuiHelper helper, IMMRecipeViewerRecipeType<ItemStackToItemStackRecipe> recipeType) {
