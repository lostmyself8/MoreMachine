...
public abstract class MMBaseRecipeCategory<RECIPE> extends AbstractContainerEventHandler implements IRecipeCategory<RECIPE>, IGuiWrapper {

    protected static IDrawable createIcon(IGuiHelper helper, IMMRecipeViewerRecipeType<?> recipeType) {
    ...
    protected MMBaseRecipeCategory(IGuiHelper helper, IMMRecipeViewerRecipeType<RECIPE> recipeType) {
        this(helper, MoreMachineJEI.recipeType(recipeType), recipeType.getTextComponent(), createIcon(helper, recipeType), recipeType.xOffset(), recipeType.yOffset(), recipeType.width(), recipeType.height());
    }

    protected MMBaseRecipeCategory(IGuiHelper helper, RecipeType<RECIPE> recipeType, Component component, IDrawable icon, int xOffset, int yOffset, int width, int height) {
...
//    }
    ...
    @Override
    public void createRecipeExtras(IRecipeExtrasBuilder builder, RECIPE recipe, IRecipeSlotsView recipeSlotsView, IFocusGroup focuses) {
        for (GuiElement guiElement : guiElements) {
