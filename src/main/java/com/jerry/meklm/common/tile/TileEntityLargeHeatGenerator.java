...
public class TileEntityLargeHeatGenerator extends LMTileEntityGenerator implements IBoundingBlock {

    private static final RelativeSide[] ENERGY_SIDES = {RelativeSide.BACK};
    ...
    public TileEntityLargeHeatGenerator(BlockPos pos, BlockState state) {
        super(LMBlocks.LARGE_HEAT_GENERATOR, pos, state, MAX_PRODUCTION.getAsLong());
    }
