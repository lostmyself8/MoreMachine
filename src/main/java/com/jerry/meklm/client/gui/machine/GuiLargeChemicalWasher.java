...
public class GuiLargeChemicalWasher extends GuiConfigurableTile<TileEntityLargeChemicalWasher, MekanismTileContainer<TileEntityLargeChemicalWasher>> {

    public GuiLargeChemicalWasher(MekanismTileContainer<TileEntityLargeChemicalWasher> container, Inventory inv, Component title) {
